# clean-architecture-setup Specification

## Purpose
TBD - created by archiving change setup-clean-architecture. Update Purpose after archive.
## Requirements
### Requirement: Estructura de la Solución
La solución del sistema PetClinic Management System MUST estar estructurada utilizando el patrón de Arquitectura Limpia (Clean Architecture), conteniendo proyectos independientes en `src/` para las capas de Domain, Application, Infrastructure y WebUI.
...
Las referencias entre proyectos MUST seguir estrictamente la regla de dependencia de Clean Architecture, donde la dirección de las dependencias va de afuera hacia adentro, teniendo a Domain como el núcleo sin dependencias de otros proyectos.
